          ...
          <Table borderless className="mb-5 borderbtm" responsive="md">
            <tbody>
              ...
              <tr>
                ...
                <td className="nametd">Dr. Ajay Sharma</td>
                <td className="afftd">Senior Research Officer/Professor, MCAST Applied Research and Innovation Centre, Malta, Europe</td>
              </tr>
              <tr>
                <td className="snowidth text-center">2</td>
                <td className="nametd">Dr. Debashree Banerje</td>
                <td className="afftd">Principal Research Engineer, Linköping University, Sweden</td>
              </tr>
              <tr>
                <td className="snowidth text-center">3</td>
                <td className="nametd">Dr. Sangita Chaki Roy</td>
                <td className="afftd">Senior Scientist, Institute of Microelectronics, Agency for Science Technology & Research A*Star, Singapore</td>
              </tr>
              <tr>
                <td className="snowidth text-center">4</td>
                <td className="nametd">Dr. S. N. Singh, Director</td>
                <td className="afftd">
              ...
              <tr>
                ...
                <td className="nametd">Dr. Satish K. Singh</td>
                <td className="afftd">Associate Professor, Indian Institute of Information Technology, Allahabad, India</td>
              </tr>
              <tr>
                <td className="snowidth text-center">6</td>
                <td className="nametd">Dr. Ashish Shrivastava</td>
                <td className="afftd">Professor, Skill Faculty of Engineering and Technology at Shri Vishwakarma Skill University, Gurugram</td>
              </tr>
              <tr>
                <td className="snowidth text-center">7</td>
                <td className="nametd">Dr. Asheesh Kumar Singh</td>
                <td className="afftd">
                Professor, Department of Electrical Engineering, Motilal Nehru National Institute of Technology Allahabad, Prayagraj, India.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="afftd">Associate Professor, EE Department, MMMUT, Gorakhpur, India</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="nametd">Dr. Roopam Gupta</td>
                <td className="afftd">VC, RGTU, Bhopal, India</td>
              </tr>
              <tr>
                <td className="snowidth text-center">12</td>
                <td className="nametd">Dr. Ashish Bagwari</td>
                <td className="afftd">HoD ECE, Women Institute of Technology (State Govt. Institution), Dehradun, Uttarakhand, India</td>
              </tr>
              <tr>
                <td className="snowidth text-center">13</td>
                <td className="nametd">Dr. Ajay Somkuwar</td>
                <td className="afftd">Professor, MANIT, Bhopal, India</td>
              </tr>
              <tr>
                <td className="snowidth text-center">14</td>
                <td className="nametd">Dr. Mirza Tariq Beg</td>
