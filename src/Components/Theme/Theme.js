...
import { Table } from "react-bootstrap";
    ...
    class Theme extends Component {
        ...
        render(){
            ...
            <h5 className="extra-bold-text mt-4">Category 1: Electronics & Communication Engineering for Sustainable Development</h5>
             ...
             */}
            <h5 className="extra-bold-text mt-4">Category 2: VLSI Design and Electronic Circuits</h5>
...
Smart grids and virtual power stations, Energy policy, low power electronics and energy recycling, Green computing case studies, Energy efficiency in the Internet of Things, Data and Information, Quality Control; Computer Vision, Distributed Computing, Software Engineering; Bioinformatics; Semantics Web, Cryptography, Digital Forensics, Mobile Security, Cloud Security, Energy Constrained Network Devices.</p> */}
            ...
            <h5 className="extra-bold-text mt-4">Category 3: RF & Microwave </h5>
             ...
             */}
            <h5 className="extra-bold-text mt-4">Category 4: Communication Systems and Networks </h5>
             ...
             */}
             <h5 className="extra-bold-text mt-4">Category 5: Embedded Systems and IoT </h5>
             <h5 className="extra-bold-text mt-4">Category 6: Signal and Image Processing </h5>
             <h5 className="extra-bold-text mt-4">Category 7: Artificial Intelligence and Machine learning </h5>
             <h5 className="extra-bold-text mt-4">Category 8: Advanced Computing Technologies </h5>
             <h5 className="extra-bold-text mt-4">Category 9: Robotics, Automation and IoT applications </h5>
