    ...
    class Theme extends Component {
        ...
        render(){
            ...
            <div className="container" >
                ...
                <h6 className="bold-text text-center">Proposed Tentative budget for the 2nd International conference on Advancements & Key Challenges in Green Energy and Computing (&nbsp;AKGEC&nbsp;-&nbsp;2022&nbsp;)</h6>
